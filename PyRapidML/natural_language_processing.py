...
def initializer(
    ...
    >>> exp_name = initializer(data = kiva, target = 'en')
    ...
    logger.info("PyRapidML NLP Module")
...
def creating_model(
    ...
    -------
    >>> from PyRapidML.datasets import get_data
    >>> kiva = extract_data('kiva')
    >>> from PyRapidML.nlp import *
    >>> exp_name = initializer(data = kiva, target = 'en')
    >>> lda = creating_model('lda')
...
def evaluate_model(model):
    ...
    >>> from PyRapidML.datasets import get_data
    >>> kiva = extract_data('kiva')
    >>> experiment_name = initializer(data = kiva, target = 'en')     
    >>> lda = creating_model('lda')
    >>> evaluate_model(lda)
...
def load_model(model_name, verbose=True):
    ...
    Example
    -------
    >>> from PyRapidML.nlp import load_model
...
def models():
    ...
    Example
    -------
    >>> from PyRapidML.nlp import models
    >>> all_models = models()
...
def get_logs(experiment_name=None, save=False):
    ...
    >>> kiva = extract_data('kiva')
    >>> from PyRapidML.nlp import *
    >>> exp_name = initializer(data = kiva, target = 'en', log_experiment = True) 
    >>> lda = creating_model('lda')
    >>> exp_logs = get_logs()
